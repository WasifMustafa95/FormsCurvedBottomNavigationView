...
namespace FormsCurvedBottomNavigation
{
    public class CurvedBottomTabbedPage : TabbedPage
    {
        ...
        public static readonly BindableProperty FabBackgroundColorProperty =
            BindableProperty.Create(nameof(FabBackgroundColor), typeof(Xamarin.Forms.Color), typeof(CurvedBottomTabbedPage), Color.SkyBlue);

        public static readonly BindableProperty NavigateToPageProperty =
            BindableProperty.Create(nameof(NavigateToPage), typeof(Page), typeof(CurvedBottomTabbedPage), null);
        ...
        public Page NavigateToPage
        {
            get { return (Page)GetValue(NavigateToPageProperty); }
            set { SetValue(NavigateToPageProperty, value); }
        }
